...
import com.mysurgery.service.APKEFTutoDownloaderService;
...
public class DownloaderActivity extends Activity implements IDownloaderClient {
    ...
    public static int initialAPKVersionCode = 24;
    public static Long mainFileSize = 93139750L;
    ...
    private void setButtonPausedState(boolean paused) {
        mStatePaused = paused;
        String stringResourceID = paused ? "resume" :
                "pause";
    ...
    public static boolean expansionFilesDelivered(Context context) {
        for (XAPKFile xf : xAPKS) {
            ...
            Log.e("ExpansionsFile", "filename:" + fileName);
        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected void onPostExecute(Boolean result) {
                if (result) {
                    ...
                    Intent intent = new Intent(DownloaderActivity.this,
    ...
    protected void onStart() {
        Log.e("DownloaderActivity", "onStart");
    ...
    protected void onResume() {
        super.onResume();
        Log.e("DownloaderActivity", "onResumn");
//        onRunActivity();
    }
    ...
    protected void onRestart() {
        super.onRestart();
        Log.e("DownloaderActivity", "onReStart");
    }
        ...
        if (!expansionFilesDelivered(getApplicationContext())) {
            try {
                ...
                if (startResult != DownloaderClientMarshaller.NO_DOWNLOAD_REQUIRED) {
                    ...
                    // show progress
                    Log.e(LOG_TAG, "Cannot find own package! NO_DOWNLOAD_REQUIRED!");
                    initializeDownloadUI();
                    return;
